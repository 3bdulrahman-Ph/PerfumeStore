...
<section class="quick-view">
    ...
    <form action="" method="POST">
         ...
         <div class="price"><?php echo $fetch_products['price']; ?> ر.ي</div>
    ...
    <?php
        ...
        echo '<p class="empty">لا توجد تفاصيل متاحة للمنتج!</p>';
        }
    }
    ?>

    <div class="more-btn">
        <a href="index.php" class="option-btn">انتقل إلى الصفحة الرئيسية</a>
    </div>
